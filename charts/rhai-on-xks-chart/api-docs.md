...
| eks.cloudManager.image | string | `"quay.io/opendatahub/opendatahub-operator:latest"` |  |
| eks.cloudManager.imagePullPolicy | string | `"Always"` |  |
| eks.cloudManager.namespace | string | `"rhai-cloudmanager-system"` |  |
| eks.enabled | bool | `false` |  |
| eks.kubernetesEngine.enabled | bool | `true` |  |
| eks.kubernetesEngine.spec.dependencies.certManager.configuration | object | `{}` |  |
| eks.kubernetesEngine.spec.dependencies.certManager.managementPolicy | string | `"Managed"` |  |
| eks.kubernetesEngine.spec.dependencies.gatewayAPI.configuration | object | `{}` |  |
| eks.kubernetesEngine.spec.dependencies.gatewayAPI.managementPolicy | string | `"Managed"` |  |
| eks.kubernetesEngine.spec.dependencies.lws.configuration.namespace | string | `"openshift-lws-operator"` |  |
| eks.kubernetesEngine.spec.dependencies.lws.managementPolicy | string | `"Managed"` |  |
| eks.kubernetesEngine.spec.dependencies.sailOperator.configuration.namespace | string | `"istio-system"` |  |
| eks.kubernetesEngine.spec.dependencies.sailOperator.managementPolicy | string | `"Managed"` |  |
| enabled | bool | `true` |  |
